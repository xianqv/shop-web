...
<body>
	<div id="main" class="wrap">
		<div class="main">
			...
			<div class="manage">
				<form action="ProductClassify_update.action" method="post">
					...
					<table class="form">
						<tr>
							...
							<tr>
								...
								<td><input type="text" class="text" name="productClassify.title" value="${ productClassify.title}"
									id="meal_name" /></td>
							</tr>
							...
							<tr>
								...
								<td><input type="color" class="text" name="productClassify.textColor"
									id="meal_name"  value="${productClassify.textColor }"/></td>
							</tr>
