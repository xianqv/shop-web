...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="main" class="wrap">
  	<div class="main">
		<h2>添加分类</h2>
		<div class="manage">
			<form action="Brand_save.action" enctype="multipart/form-data" method="post">
				<table class="form">
					<tr>
					...
					<tr>
						<td class="field">商品类型名称：</td>
						<td><input type="text" class="text" name="brand.name" id="meal_name"/></td>
					</tr>
					...
					<tr>
						<td class="field">是否名牌：</td>
						<td><select name="brand.isbig">
							<option>--请选择--</option>
