...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <div id="main" class="wrap">
  	<div class="main">
		<h2>添加尺寸</h2>
		<div class="manage">
			<form action="Size_saveColor.action"  method="post">
				...
				<table class="form">
					...
					<tr>
						<td class="field">颜色名称</td>
						<td>
						<input type="text" class="text tiny" name="color.name" />
						</td>
						<td class="field">数量</td>
						<td>
						<input type="text" class="text tiny" name="color.num" /> 件
						</td>
					</tr>
